...
export async function generateMetadata({ params }: { params: { slug: string } }) {
  try {
    ...
    return constructMetadata({
      title: `${project.title} - John Doe's Portfolio`,
    ...
    console.error(`Error generating metadata for project with slug ${params.slug}:`, error)
    return constructMetadata({
    ...
    return (
      <main className="container py-12 md:py-24 lg:py-32">
        <div className="mx-auto max-w-3xl text-center">
          <h1 className="text-3xl font-bold tracking-tighter sm:text-4xl md:text-5xl">Error Loading Project</h1>
          <p className="mt-4 text-muted-foreground">There was an error loading this project. Please try again later.</p>
