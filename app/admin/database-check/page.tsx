...
export default function DatabaseCheckPage() {
  ...
  return (
    <div className="flex flex-col gap-4">
      <h1 className="text-3xl font-bold tracking-tight">Database Connection Check</h1>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Verify that your application can connect to the database</CardDescription>
        </CardHeader>
        <CardContent>
          {status === "loading" && (
          ...
          {status === "error" && (
            <Alert variant="destructive">
              ...
              <AlertDescription>
                ...
                {error && (
                  <div className="mt-2 p-2 bg-destructive/20 rounded text-sm font-mono overflow-auto">{error}</div>
                )}
              </AlertDescription>
            </Alert>
          )}
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Check that your database environment variables are properly configured</CardDescription>
        </CardHeader>
        <CardContent>
          <div className="space-y-4">
            <div>
              ...
              <ul className="list-disc pl-5 mt-2 space-y-1">
                ...
                <li>DIRECT_URL - Direct connection URL (for Prisma migrations)</li>
              </ul>
            </div>
            ...
            <Alert>
              ...
              <AlertDescription>
                <p className="text-sm">
                  For security reasons, we can't display your actual environment variables. Please check your Vercel
                  project settings to ensure they are correctly set.
                </p>
              </AlertDescription>
            </Alert>
          </div>
