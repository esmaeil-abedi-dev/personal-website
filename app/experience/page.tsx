  ...
  return (
    <main className="container py-12 md:py-24 lg:py-32">
      <div className="mx-auto max-w-3xl">
        <h1 className="text-3xl font-bold tracking-tighter sm:text-4xl md:text-5xl mb-12">Experience</h1>
        ...
        <section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {skills.length > 0 ? (
              ...
              <p className="text-muted-foreground col-span-2">No skills found.</p>
            )}
          </div>
        </section>
      </div>
